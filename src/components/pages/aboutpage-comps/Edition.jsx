      ...
      <section className="grid gap-10">
        ...
        <article className="bg-gray-d relative border-[1px] border-primary-color/30 rounded-lg overflow-hidden">
          ...
          <section className="p-6">
            <h4>Demo reel - Jackson Kidd</h4>
            <p className="text-gray-400 text-md mt-2">
              Demo reel by Jackson Kidd Contreras, video editor located in the
        ...
        <article className="bg-gray-d relative border-[1px] border-primary-color/30 rounded-lg overflow-hidden">
          ...
          <section className="p-6">
            ...
            <p className="text-gray-400 text-md mt-2">
              ...
              Caracol. Journalist: Marcela Pulido. Editing and coloring: Jackson
              Kidd. Language: spanish. December 2020.
            </p>
            <a
      ...
      <section className="grid gap-10">
        <article className="bg-gray-d relative border-[1px] border-primary-color/30 rounded-lg overflow-hidden">
          ...
          <section className="p-6">
            ...
            <p className="text-gray-400 text-md mt-2">
              Chronicle edited for the Project is Colombia from Noticias
              Caracol. Journalist: Victor Grosso. Editing and coloring: Jackson
              Kidd. Language: spanish. December 2020.
            </p>
            <a
